...
class EnquiryController extends Controller
{
    public function index(Request $request)
    {
                    ...
                    return '
                        <div class="d-flex gap-1">
                            <a href="javascript:void(0);" data-title="Edit Enquiry"
                                data-route="' . route('admin.enquiry.edit', $row->id) . '" class="btn btn-sm btn-primary common_model" title="Edit">
                            ...
                            <button
                                ...
                                data-route="' . route('admin.enquiry.destroy', $row->id) . '"
                                title="Delete">
        ...
        return view('admin.pages.enquiry.index');
    }

    public function create()
    {
        $html = view('admin.pages.enquiry.create')->render();
    ...
    public function edit($id)
    {
        ...
        $html = view('admin.pages.enquiry.edit', compact('enquiry'))->render();
