    ...
    <div class="section">
        <div class="container">
            <div class="section-header">
                ...
                <h2 class="section-title">What Our Botany Students <span class="accent">Say</span>
                </h2>
                <p class="section-subtitle">Real experiences from PGTRB and UGTRB Botany students who prepared, progressed, and achieved their goals with Arunai Academy, Dharmapuri.</p>
            </div>
