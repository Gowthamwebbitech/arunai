...
@section('content')
    ...
    <section class="pgtrb-section py-60">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">Our UGTRB Botany course helps students build a strong foundation with
                    exam-oriented teaching, high-scoring topic focus, regular practice, and smart preparation techniques.
                </p>
            </div>
    ...
    <div style="background:linear-gradient(135deg, #004a63, #1a5c2a);padding:70px 2rem;text-align:center;">
        <h3 style="font-family:'Playfair Display',serif;color:#fff;font-size:2rem;margin-bottom:1rem;">Ready to Start Your
            Journey?</h3>
        <p
