...
@section('content')
    ...
    <section class="pgtrb-section py-60">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">Our PGTRB Botany course is designed for serious aspirants who aim for top ranks.
                    The course includes complete syllabus coverage, advanced preparation strategies, model exams, intensive
                    revision, and rank-focused training.
                </p>
            </div>
    ...
    <div style="background:linear-gradient(135deg, #004a63, #1a5c2a);padding:70px 2rem;text-align:center;">
        <h3 style="font-family:'Playfair Display',serif;color:#fff;font-size:2rem;margin-bottom:1rem;">Advance Your Academic
            Career</h3>
        <p
