        ...
        <div class="container">
            <div class="contact-row"
                ...
                <div
                    ...
                    <div style="color:var(--green-mid);font-size:0.85rem;margin-top:0.2rem;"><a class="text-dark;" style="text-decoration: unset; color:black" href="tel:+91 9500244679">+91 9500244679</a></div>
                    <div style="color:var(--green-mid);font-size:0.85rem;margin-top:0.2rem;"><a class="text-dark;" style="text-decoration: unset; color:black" href="tel:+91 7010753971">+91 7010753971</a></div>
                </div>
    ...
    <div style="background:var(--gray-light);padding:80px 2rem;">
        <div style="max-width:800px;margin:0 auto;">
            <div class="section-header">
                ...
                <h3 class="section-title">Frequently Asked <span class="accent">Questions</span></h3>
            </div>
