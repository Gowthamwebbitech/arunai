    ...
    <section class="page-hero">
        <div class="page-hero-content">
            ...
            <div class="breadcrumb">
                <a href="{{ route('index') }}">Home</a><span class="breadcrumb-sep">›</span><span>Study Materials</span>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="card-grid">
                @foreach ($materials as $item)
                    <div class="pdf-card">
                        <img src="{{ asset('assets/images/pdf.png') }}" alt="TRB Coaching Centre Tamil Nadu">
                        <h3>{{ $item->title }}</h3>
