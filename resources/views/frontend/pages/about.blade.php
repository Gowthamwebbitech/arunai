...
@section('content')
            ...
            <div class="about-grid">
                <div class="about-img-wrap reveal">
                    <div class="about-img-main">
                        <img src="{{ asset('assets/images/graduation-cap.webp') }}" alt="TRB Botany Coaching Institute Tamil Nadu " />
                    </div>
                ...
                <div class="about-text reveal">
                    ...
                    <a href="{{ route('contact') }}" class="btn-primary" style="margin-top:1rem;display:inline-flex;"> Get
                        in touch →</a>
                </div>
            </div>
        </div>
    ...
    <div class="section-full section-dark" style="text-align:center;">
        <div style="max-width:1400px;margin:0 auto;padding:0 2rem;">
            ...
            <h3 class="section-title" style="color:#fff;margin-bottom:3rem;">Numbers That <span
                    style="color:#5dbf6e">Speak</span></h3>
    ...
    <div class="section">
        <div class="container">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:2rem;" class="reveal">
                <div
                    style="background:radial-gradient(#006b4e, #194360, #124963);border-radius:24px;padding:2.5rem;color:#fff;">
                    <div style="font-size:2.5rem;margin-bottom:1rem;">🎯</div>
                    <h3 style="font-family:'Playfair Display',serif;font-size:1.4rem;margin-bottom:1rem;">Our Mission</h3>
                    <p style="color:rgba(255,255,255,0.8);line-height:1.8;font-size:0.95rem;">Our mission is to provide
                        result-oriented Botany coaching that helps every aspirant achieve their dream of becoming a
                        government teacher.</p>
                    <h4>We focus on: </h4>
                ...
                <div
                    style="background:var(--white);border-radius:24px;padding:2.5rem;box-shadow:0 4px 20px rgba(0,0,0,0.06);border:1px solid rgba(45,140,78,0.1);">
