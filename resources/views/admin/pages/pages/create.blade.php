...
@section('content')
    ...
    <div class="main admin-card p-4">
        ...
        <div class="card-custom table table-hover w-100">
            ...
            <form method="POST" id="pageForm" action="{{ route('admin.pages.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div id="faq-container">
                        <div class="faq-item row mb-2">
                            ...
                            <div class="col-sm-7">
                                <textarea name="faqs[1][answer]" class="form-control faq-answer" placeholder="Answer"
                                    rows="4"></textarea>
                            </div>
                            {{-- <div class="col-sm-3">
                                <textarea name="faqs[1][schema]" class="form-control faq-schema"
                                    placeholder="Paste FAQ Schema here" style="height: 80px; overflow-y: auto;"></textarea>
                            </div> --}}
                            <div class="col-sm-1">
                ...
                <div id="schema-container">
                    ...
                    <div class="schema-item row mb-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-7">
                            ...
                            <textarea name="schemas[0][code]" class="form-control" rows="4"
                                placeholder="Paste Schema Code"></textarea>
                        </div>

                        <div class="col-md-1">
                            <button type="button" class="btn btn-sm btn-primary mt-4" id="add-schema">
                                Add
                            </button>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '#add-schema', function () {
                ...
                let schemaItem = `
                                <div class="schema-item row mb-3 align-items-center">
